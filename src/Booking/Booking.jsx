...
import { Grid, Box, GridItem, Image, Text, Button, AlertDialog } from "@chakra-ui/react";
...
const Booking = () => {
  ...
  <FormLabel  width={"200px" }>Email address :</FormLabel>
  <Input width={"400px" } type='email' />
  </Box>
  <Box display={"flex"}marginBottom={"10px"}>

  <FormLabel  width={"200px" }>First Name :</FormLabel>
<Input  width={"400px" } type='Text' />
</Box>
<Box display={"flex"}marginBottom={"10px"}>
  ...
  <Box display={"flex"}marginBottom={"10px"}>
  <FormLabel  width={"200px" }>Address :</FormLabel>
  <Input  width={"400px" } type='Text' />
  </Box>
  <Box display={"flex"}marginBottom={"10px"}>
  <FormLabel  width={"200px" }>City :</FormLabel>
  <Input  width={"400px" } type='Text' />
  </Box>
  <Box display={"flex"}marginBottom={"10px"}>
  <FormLabel  width={"200px" }>Pin :</FormLabel>
  <Input  width={"400px" } type='Text' />
  </Box>
  <Box display={"flex"}marginBottom={"10px"}>
  <FormLabel  width={"200px" }>Country :</FormLabel>
  <select style={{
    width:"300px",
...
<Button onClick={ alert("Your order has successfully placed! Thank you for shopping with us!") } backgroundColor={"yellow"}width={"620px"}> Confirm</Button>
</Box>
</FormControl>
     </Box>
